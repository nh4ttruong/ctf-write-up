...
[Source website and devme.html here](https://github.com/nh4ttruong/ctf-write-up/blob/main/cor-ctf-2021/devme/devme_files.zip)
...
Source buyme.tar.xz [chall folder](https://github.com/nh4ttruong/ctf-write-up/blob/main/cor-ctf-2021/buyme/chall.rar)
...
The challenge has two source code: [enc.py](https://github.com/nh4ttruong/ctf-write-up/blob/main/cor-ctf-2021/fibinary/enc.py) and [flag.enc](cor-ctf-2021/fibinary/flag.enc)

### Solution

The source code [enc.py](https://github.com/nh4ttruong/ctf-write-up/blob/main/cor-ctf-2021/fibinary/enc.py):
```python
fib = [1, 1]
for i in range(2, 11):
