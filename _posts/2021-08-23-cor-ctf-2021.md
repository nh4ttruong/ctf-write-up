...
![](cor-ctf-2021/devme/statement.png)

[Source website and devme.html here](cor-ctf-2021/devme/devme_files.zip)
...
![Result](cor-ctf-2021/devme/structure.png)
...
![Result](cor-ctf-2021/devme/users.png)
...
![flag](cor-ctf-2021/devme/flag.png)

## crypto/fibinary

### Challenge

![](cor-ctf-2021/fibinary/state.png)

The challenge has two source code: [enc.py](cor-ctf-2021/fibinary/enc.py) and [flag.enc](cor-ctf-2021/fibinary/flag.enc)

### Solution

The source code [enc.py](cor-ctf-2021/fibinary/enc.py):
```python
fib = [1, 1]
for i in range(2, 11):
...
![Result](cor-ctf-2021/fibinary/flag.png)
...
![](cor-ctf-2021/buyme/state.png)

Web challenge: https://buyme.be.ax/

Source buyme.tar.xz [chall folder](cor-ctf-2021/buyme/chall.rar)
